...
public class Thousand {
	...
	private ArrayList<String> cheonjamean= new ArrayList<String>();
	...
	public void sentprt() {
		...
		for(int j=0; j<2; j++) {
			for(int i=0; i<8; i++) {
				if(j==0) {
					System.out.print(cheonja.get(8*a+i));
					if(i==3) {
						System.out.print(" ");
					}
				}else {
					System.out.print(cheonjayin.get(8*a+i));
					if(i==3) {
						System.out.print(" ");
					}
				}
	...
	public ArrayList<String> getCheonjamean() {
		return cheonjamean;
	}
