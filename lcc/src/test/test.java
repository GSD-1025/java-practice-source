...
public class test {
	...
	public static void main(String[] args) {
		String cheonjayin1= "천지현황 우주홍황  " + "일월영측 진수렬장  " + "한래서왕 추수동장  " + "윤여성세 율여조양  " + 
				...
				"위어조자 언재호야";
		ArrayList<Character> cheonjayin2= new ArrayList<Character>();
		for(int i=0;i<cheonjayin1.length(); i++) {
			if(cheonjayin1.charAt(i)!=' ') {
				cheonjayin2.add(cheonjayin1.charAt(i));
			}
		}
		System.out.println(cheonjayin2.size());
